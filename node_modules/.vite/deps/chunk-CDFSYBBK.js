...
var PropsContext = React14.createContext(void 0);
...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React17.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React17.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React17.useMemo(() => storageManager == null ? void 0 : storageManager({
  ...
  const [isClient, setIsClient] = React17.useState(noSsr || !isMultiSchemes);
  React17.useEffect(() => {
    setIsClient(true);
  }, []);
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React18.useContext(ColorSchemeContext) || defaultContext;
  ...
  function CssVarsProvider(props) {
    ...
    const initialTheme = React18.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React18.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const memoTheme = React18.useMemo(() => {
      var _a2;
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React18.Fragment, {
...
function isMuiElement(element, muiNames) {
  var _a, _b, _c;
  return React20.isValidElement(element) && muiNames.indexOf(
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CDFSYBBK.js.map
